...
import rockthejvm.akkaTyped.BaeldungAkkaTyped.Bank.{CreatePortfolio, PortfolioCreated}
import rockthejvm.akkaTyped.BaeldungAkkaTyped.PortfolioActor.{Buy, PortfolioCommand}

import scala.concurrent.duration._
import scala.util.{Failure, Success}

// https://www.baeldung.com/scala/typed-akka
object BaeldungAkkaTyped extends App {
  object BankMain {
    ...
    def apply(): Behavior[Start] =
      Behaviors.setup { context =>
        ...
        Behaviors.receiveMessage { message: Start =>
